...
*/
  ...
  function remover(s){
	...
	.done(function(res) {
		cargarTabla2();
		swal("Exito", "Desvinculación realizada!", "success");
...
function buscarEmail() {
	// Declare variables
	var input, filter, table, tr, td,tds, i, cellValue, campo, campoV;

	table = document.getElementById("tb2");
	campo = document.getElementById("nombreT");
	campoV = document.getElementById("nombreT").value;
   ...
   if(campo.length<3){
   alert("El correo debe ser mayor de 3 caracteres")
