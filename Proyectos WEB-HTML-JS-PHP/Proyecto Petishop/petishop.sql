...
CREATE TABLE IF NOT EXISTS `detalle_devolucion` (
  `cve_detdev` int NOT NULL AUTO_INCREMENT,
  `cve_pro` int NOT NULL,
  `email_usu` varchar(50) NOT NULL,
  PRIMARY KEY (`cve_detdev`),
  KEY `cve_pro` (`cve_pro`),
...
CREATE TABLE IF NOT EXISTS `detalle_proveedorproducto` (
  `num_provpro` int NOT NULL AUTO_INCREMENT,
  `fecha_provpro` date NOT NULL,
  `cve_pro` int NOT NULL DEFAULT '0',
  `cve_prov` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`num_provpro`),
  KEY `codigo_pro` (`cve_pro`) USING BTREE,
  KEY `cve_prov` (`cve_prov`),
  CONSTRAINT `cve_pro` FOREIGN KEY (`cve_pro`) REFERENCES `producto` (`cve_pro`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `cve_prov` FOREIGN KEY (`cve_prov`) REFERENCES `proveedor` (`cve_prov`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DELETE FROM `detalle_proveedorproducto`;
/*!40000 ALTER TABLE `detalle_proveedorproducto` DISABLE KEYS */;
INSERT INTO `detalle_proveedorproducto` (`num_provpro`, `fecha_provpro`, `cve_pro`, `cve_prov`) VALUES
	(5, '2022-07-29', 69, 1),
	(6, '2022-07-29', 2, 1),
	(7, '2022-07-29', 63, 1);
/*!40000 ALTER TABLE `detalle_proveedorproducto` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `detalle_venta` (
  `cve_detven` int NOT NULL AUTO_INCREMENT,
  `codigo_pro` varchar(50) NOT NULL,
  `email_usu` varchar(50) NOT NULL,
  PRIMARY KEY (`cve_detven`),
  KEY `codigo_pro` (`codigo_pro`),
  KEY `email_usu` (`email_usu`),
  CONSTRAINT `codigo_pro` FOREIGN KEY (`codigo_pro`) REFERENCES `producto` (`codigo_pro`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `email_usu` FOREIGN KEY (`email_usu`) REFERENCES `usuario` (`email_usu`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DELETE FROM `detalle_venta`;
/*!40000 ALTER TABLE `detalle_venta` DISABLE KEYS */;
INSERT INTO `detalle_venta` (`cve_detven`, `codigo_pro`, `email_usu`) VALUES
	(5, '111222333', 'angel123@gmail.com'),
	(6, '111222333', 'angel123@gmail.com'),
	(7, '1112225', 'rodrigo123@gmail.com');
/*!40000 ALTER TABLE `detalle_venta` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `devolucion` (
  `cve_dev` int NOT NULL AUTO_INCREMENT,
  `fecha_dev` int NOT NULL,
  `motivo_dev` int NOT NULL,
  PRIMARY KEY (`cve_dev`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='Tabla de Estados de la República Mexicana';
...
CREATE TABLE IF NOT EXISTS `municipios` (
  ...
  CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2465 DEFAULT CHARSET=utf8 COMMENT='Municipios de la República Mexicana';
...
INSERT INTO `municipios` (`id`, `estado_id`, `clave`, `nombre`, `activo`) VALUES
	...
	(2464, 33, '888', 'Por Asignar', 1);
/*!40000 ALTER TABLE `municipios` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `producto` (
  `cve_pro` int NOT NULL AUTO_INCREMENT,
  `nombre_pro` varchar(50) NOT NULL DEFAULT '',
  `codigo_pro` varchar(50) NOT NULL DEFAULT '',
  `tipo_pro` varchar(50) NOT NULL DEFAULT '',
  `existencia_pro` varchar(50) NOT NULL DEFAULT '',
  `descripcion_pro` varchar(50) NOT NULL DEFAULT '',
  `imagen_pro` longblob NOT NULL,
  `precio_pro` double NOT NULL DEFAULT '0',
  `garantia_pro` varchar(50) NOT NULL DEFAULT '',
  `promocion_pro` varchar(50) NOT NULL,
...
INSERT INTO `producto` (`cve_pro`, `nombre_pro`, `codigo_pro`, `tipo_pro`, `existencia_pro`, `descripcion_pro`, `imagen_pro`, `precio_pro`, `garantia_pro`, `promocion_pro`, `status_pro`) VALUES
	(2, 'Ipad Air 4', '1112225', 'Tablet', '20', 'Tablet inteligente', _binary 0x697061642e6a7067, 8900, '2 años', 'Ninguna', 'activo'),
	(63, 'Iphone 13 pro', '111222333', 'Smartphone', '30', 'Telefono inteligente', _binary 0x6970686f6e652e6a7067, 22000, 'Ninguna', 'Ninguna', 'activo'),
	(64, 'Xbox Series', '33423', 'Consola', '30', 'Consola de videojuegos', _binary 0x78626f782e6a7067, 22000, 'Ninguna', 'Ninguna', 'activo'),
	(65, 'Sony Bravia 4kD', '1111', 'Pantalla', '22', 'Pantalla 4k', _binary 0x70616e74616c6c612e6a7067, 15000, '2 años', 'Ninguna', 'activo'),
	(66, 'Samsumg S20', '21236652', 'Smartphone', '20', 'Telefono Inteligente', _binary 0x73616d73756d672e6a7067, 22000, 'Ninguna', 'Ninguna', 'activo'),
	(67, 'Playstation 4', '222333555', 'Consola', '10', 'Consola de videojuegos', _binary 0x7073342e6a7067, 18000, '1 años', 'Ninguna', 'activo'),
	(68, 'Nintendo Switch', '111222336', 'Consola', '10', 'Consola de videojuegos', _binary 0x6e696e74656e646f2e6a7067, 12000, '1 año', 'Ninguna', 'activo'),
	(69, 'Airpods 4 gen', '11222355', 'Audifonos', '50', 'Audifonos inalambricos', _binary 0x616972706f64732e6a7067, 80000, '1 año', 'Ninguna', 'activo');
...
CREATE TABLE IF NOT EXISTS `proveedor` (
  ...
  `email_prov` varchar(50) NOT NULL DEFAULT '',
  `nombre_prov` varchar(50) NOT NULL DEFAULT '',
  `paterno_prov` varchar(50) NOT NULL DEFAULT '',
  `domicilio_prov` varchar(50) NOT NULL DEFAULT '',
  `estado_prov` varchar(50) NOT NULL DEFAULT '',
  `pais_prov` varchar(50) NOT NULL DEFAULT '',
  `edad_prov` date DEFAULT NULL,
  PRIMARY KEY (`cve_prov`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DELETE FROM `proveedor`;
/*!40000 ALTER TABLE `proveedor` DISABLE KEYS */;
INSERT INTO `proveedor` (`cve_prov`, `email_prov`, `nombre_prov`, `paterno_prov`, `domicilio_prov`, `estado_prov`, `pais_prov`, `edad_prov`) VALUES
	(1, 'luis123@gmail.com', 'Luis', 'Salles', 'av revolucion 12', 'Michoacan', 'Mexico', '1992-09-29'),
	(2, 'carlos123@gmail.com', 'Carlos', 'Ruiz', 'sonora 23', 'Michoacan', 'Mexico', '1989-07-22'),
	(3, 'ricardo123@gmail.com', 'Ricardo', 'Olivera', 'rio magalena 7', 'Cdmx', 'Mexico', '1988-07-29');
/*!40000 ALTER TABLE `proveedor` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `usuario` (
  `cve_usu` int NOT NULL AUTO_INCREMENT,
  `email_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `password_usu` varchar(50) NOT NULL,
  `nombre_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `paterno_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `materno_usu` varchar(50) NOT NULL,
  `genero_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nacimiento_usu` date NOT NULL,
  `pais_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `estado_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ciudad_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `colonia_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `cp_usu` varchar(50) NOT NULL DEFAULT '',
  `calle_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `municipio_usu` varchar(50) DEFAULT NULL,
  `status_usu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`cve_usu`) USING BTREE,
  KEY `email_usu` (`email_usu`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DELETE FROM `usuario`;
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`cve_usu`, `email_usu`, `password_usu`, `nombre_usu`, `paterno_usu`, `materno_usu`, `genero_usu`, `nacimiento_usu`, `pais_usu`, `estado_usu`, `ciudad_usu`, `colonia_usu`, `cp_usu`, `calle_usu`, `municipio_usu`, `status_usu`) VALUES
	(1, 'rodrigo123@gmail.com', '12345', 'Rodrigoo', 'Blancass', 'Moraless', 'M', '2000-05-07', 'Mexicoo', 'Chiapas', 'Cdmx', 'Magdalena contreras', '10500', 'Hermenegildo galeana 53', 'El Llano', 'activo'),
	(2, 'macotela123@gmail.com', 'macotela123', 'Marco', 'Macotela', 'Hernandez', 'M', '1998-07-02', 'Mexico', 'Chiapas', 'Zitacuaro', 'Melchor ocampo', '61506', 'Nicolas bravo sur 12', 'El Llano', 'activo'),
	(3, 'angel123@gmail.com', 'angel123', 'Angel', 'Lopez', 'Reyes', 'M', '2000-01-02', 'Mexico', 'Michoacan', 'Zitacuaro', 'Lomas de oriente', '61450', 'Cerro de coyota 27', 'El Llano', 'activo'),
	(40, 'rodrigo003@gmail.com', '12345', 'dasdsa', 'dasda', 'asdad', 'M', '2022-07-07', 'Mexico', 'Baja California Sur', 'adsad', 'dadsa', '32132', 'daadsa', 'El Llano', 'activo');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;

CREATE TABLE IF NOT EXISTS `venta` (
  `cve_ven` int NOT NULL AUTO_INCREMENT,
  `fecha_ven` date NOT NULL,
  `total_ven` float NOT NULL,
  `pago_ven` varchar(50) NOT NULL,
  `motivo_ven` varchar(50) DEFAULT NULL,
  `status_ven` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `cantidad_ven` int NOT NULL,
  `cve_detven` int NOT NULL,
  `num_provpro` int DEFAULT NULL,
  PRIMARY KEY (`cve_ven`),
  KEY `cve_detven` (`cve_detven`),
  KEY `cve_provpro` (`num_provpro`),
  CONSTRAINT `cve_detven` FOREIGN KEY (`cve_detven`) REFERENCES `detalle_venta` (`cve_detven`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `num_provpro` FOREIGN KEY (`num_provpro`) REFERENCES `detalle_proveedorproducto` (`num_provpro`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DELETE FROM `venta`;
/*!40000 ALTER TABLE `venta` DISABLE KEYS */;
INSERT INTO `venta` (`cve_ven`, `fecha_ven`, `total_ven`, `pago_ven`, `motivo_ven`, `status_ven`, `cantidad_ven`, `cve_detven`, `num_provpro`) VALUES
	(4, '2022-07-29', 22000, 'Tarjeta de credito', 'Defecto de fabrica', 'Finalizada', 2, 5, 5),
	(5, '2022-07-29', 14000, 'Tarjeta de debito', 'Sin motivo', 'Finalizada', 1, 7, 5);
