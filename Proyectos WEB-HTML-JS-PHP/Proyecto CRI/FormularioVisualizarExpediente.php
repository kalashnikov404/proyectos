...
$query4 = "SELECT nombre_persona, paterno_persona, materno_persona,
 temp2e_persona, genero_persona,  TIMESTAMPDIFF(YEAR, nacimiento_persona, 
 CURDATE()) AS edad_persona, temp1d_persona from
 persona where id_persona='$somevar'";
	...
	TIMESTAMPDIFF(YEAR, p.nacimiento_persona, 
		...
		d.estado_domicilio AS estado, d.municipio_domicilio AS municipio, 
	   ...
	   $resultado6=$mysqli->query($query6);
		...
		responsable.telefono_responsable AS telefono, domicilio.estado_domicilio AS estado,
...
#container:hover, #container2:hover, input:hover, textarea:hover{

	cursor: pointer;
}

#temporalExpediente, #temporalExpedienteFrontal{
			...
			<ul class="field-list">
						<li>
							...
							<?php while($row4= $resultado4->fetch_assoc()) { ?>	
								...
								<input type="text" name="nombrePersona"  value="<?php 
						echo $row4['nombre_persona']; ?>" disabled>
						...
						<li>
							...
							<div class="form-input">
								<input type="text" name="paternoPersona" value="<?php 
						echo $row4['paterno_persona']; ?>"disabled> 
							</div>
						</li>
						...
						<li>
							...
							<div class="form-input">
								<input type="text" name="maternoPersona" value="<?php 
						echo $row4['materno_persona']; ?>"disabled>
							</div>
						</li>
						...
						<li>
							...
							<div class="form-input">
								<input type="text" name="expedienteFrontal" id="expedienteFrontal" value="<?php 
						echo $row4['temp2e_persona']; ?>"disabled>
							</div>
						</li>
                        ...
                        <li>
							...
							<div class="form-input">
								<input type="text" name="generoFrontal" id="generoFrontal"  value="<?php 
						echo $row4['genero_persona']; ?>"disabled>
							</div>
						</li>
						...
						echo $row4['edad_persona']; ?>"disabled>
							</div>
						</li>
...
<li>
	...
	<div class="form-input">
		<input type="text" name="temporalExpedienteFrontal" id="temporalExpedienteFrontal" 
		 value="<?php echo $row8['especialidad_tratante'], 
		 '&nbsp;', $row8['nombre_persona'], '&nbsp;',
		  $row8['paterno_persona'], '&nbsp;'
		  , $row8['materno_persona'], '&nbsp;'
		  ,$row8['cedula_tratante']; ?>"disabled>
	</div>
</li>
...
<?php } ?>
						...
						<li> 
							...
							<div class="form-input2">
								<textarea rows="5" cols="20" name="temporalDiagnostico" disabled id="temporalDiagnostico"><?php 
			...
			<form action="javascript:crearHojaConsentimiento();"  id="formPaciente" method="post">
				...
				<li>
						<label class="form-label">
							...
							<input type="text" name="temporalPaciente1" disabled id="temporalPaciente1" value="<?php 
						...
						<p align="justify">por mi propio derecho o en representación del (la) menor o persona con discapcidad; 									
							<input type="text" name="temporalPaciente2" disabled id="temporalPaciente2"  value="<?php 
