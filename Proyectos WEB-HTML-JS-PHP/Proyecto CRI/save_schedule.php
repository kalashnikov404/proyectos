<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] !='POST'){
        echo "<script> alert('Error: No data to save.'); location.replace('./GestionarCita.php') </script>";
        $conn->close();
        exit;
    }
    ...
    if($save){
        echo "<script> alert('Schedule Successfully Saved.'); location.replace('./GestionarCita.php') </script>";
