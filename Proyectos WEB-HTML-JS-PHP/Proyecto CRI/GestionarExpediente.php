		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2> <b>LISTA DE EXPEDIENTES ABIERTOS</b></h2>
						</div>
						<div class="col-xs-6">
							<a href="FormularioCrearExpediente.php" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>AÑADIR EXPEDIENTTE</span></a>
...
function visualizarExpediente(elm){

	var x=  $(elm).closest("tr").find("td:nth-child(1)").text();

 location.href = "FormularioVisualizarExpediente.php?uid=" + parseInt(x);
...
function actualizarExpediente(elm){
...
//var value = localStorage.getItem(x); 
 ...
 location.href = "FormularioActualizarExpediente.php?uid=" + parseInt(x);
...
function digitalizarExpediente(idpersona){
	var idpersona=  $(idpersona).closest("tr").find("td:nth-child(1)").text();
