		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2 class="titulo"> <b>LISTA DE DESCUENTOS</b></h2>
						</div>
						<div class="col-xs-6">
							<a href="FormularioCrearDescuento.php" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>AÑADIR DESCUENTO</span></a>
...
location.href = "FormularioActualizarDescuento.php";
...
location.href = "FormularioVisualizarDescuento.php";
