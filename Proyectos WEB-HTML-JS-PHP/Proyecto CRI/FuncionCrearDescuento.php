            ...
            case 'consultar2':
                ...
                while ($ren = $consul->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    <td>$ren[id_persona]</td>
                                ...
                                <td>
                            <a  onclick='javascript:actualizarDescuento();' class='edit' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Editar'>&#xE254;</i></a>
                            <a  onclick='javascript:visualizarDescuento();' class='delete' data-toggle='modal'><i  class='fa fa-eye' data-toggle='tooltip' title='Ver'></i></a>
