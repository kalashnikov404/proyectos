...
botón eliminación del evento o cancelación del evento y pedirá motivo de cancelación qué se pondrá en estatus, cancelado o inactivo no se elimina solo se quita de los activos.
6 botón pospuesto ponerlo en parar. 
Activo, cancelado y pospuesto 
(modificación, eliminación, pospuesto y detalla por cada sección)
7 notas( opcional) describe el evento
Si ya cancelo no se puede gestionar solo los detalles 
Si es pospuesto se puede realizar todo 
Eliminar solo el de detalles 
Terminado solo detalles 
4( activo, eliminado, pospuesto y terminado)
*/
