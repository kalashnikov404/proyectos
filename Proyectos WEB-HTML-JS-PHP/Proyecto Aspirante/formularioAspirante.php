...
<legend id="head2" style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; color: rgb(255, 255, 255); font-size: 40px;" class="text-center header">Tabla de datos de los aspirantes</legend>
...
<div class="consult">
    ...
    <button  id="btnRegistrar" onclick="detallar3();">Nuevo registro</button>&nbsp;
 
    <button  id="btnCargar" onclick="cargarCsv();">Cargar participantes</button>&nbsp;
