...
public class ModificarCliente extends JPanel {
	...
	if(usuario.equals("dueño") || usuario.equals("empleado")) {
		...
		try {
			...
			JButton btnModificar = new JButton("Modificar Personal");
			btnModificar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(salida.equals("Personal modificado")) {
			...
			btnModificar.setBounds(994, 599, 185, 71);
			add(btnModificar);
			...
			btnSalir.setBounds(44, 562, 85, 81);
			add(btnSalir);
