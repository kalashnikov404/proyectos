...
public class ModificarProveedor extends JPanel {
	...
	public ModificarProveedor(String usuario) {
		...
		try {
			...
			JLabel lbProveedor = new JLabel("Paciente:");
			...
			btnModificar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(salida.equals("Paciente modificado")) {
						...
						JOptionPane.showMessageDialog(null, "Algo ha salido mal, revisa los datos ingresados");
					}	
					...
					if(salida2.equals("Paciente modificado")) {
			...
			btnModificar.setBounds(1082, 579, 185, 71);
			add(btnModificar);
			...
			btnSalir.setBounds(41, 579, 85, 81);
			add(btnSalir);

			JButton btnEliminar = new JButton("Borrar Paciente");
			...
			btnEliminar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(salida.equals("Paciente borrado")) {
						JOptionPane.showMessageDialog(null, salida);
					}else {
			...
			btnEliminar.setBounds(855, 579, 185, 71);
			add(btnEliminar);
