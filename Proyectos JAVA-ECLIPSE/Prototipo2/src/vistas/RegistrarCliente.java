	...
	public RegistrarCliente(String usuario) {
		...
		if(usuario.equals("dueño") || usuario.equals("empleado")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Registrar Personal");
				...
				JLabel lblNewLabel_4 = new JLabel("Tipo de personal:");
				...
				JButton btnNewButton = new JButton("Registrar personal");
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(salida.equals("Personal registrado") && salida2.equals("Personal registrado")) {
				...
				btnNewButton.setBounds(1056, 517, 185, 71);
				add(btnNewButton);
				...
				btnSalir.setBounds(40, 517, 85, 81);
				add(btnSalir);
