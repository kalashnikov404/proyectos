...
public class ConsultarHorario extends JPanel {
	...
	public ConsultarHorario(String usuario) {
		...
		try {
			...
			tsHrEntrada.setBounds(543, 121, 104, 31);
			...
			JRadioButton rbEmpleado = new JRadioButton("Personal");
			...
			btnBuscar.setBounds(1226, 69, 118, 31);
			add(btnBuscar);
			...
			btnTodo.setBounds(1127, 581, 185, 71);
			add(btnTodo);
			...
			btnSalir.setBounds(18, 581, 85, 81);
			add(btnSalir);
