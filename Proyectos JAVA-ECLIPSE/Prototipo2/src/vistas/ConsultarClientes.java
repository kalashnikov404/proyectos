	...
	public ConsultarClientes(String usuario) {
		...
		if(usuario.equals("dueño") || usuario.equals("empleado")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Consultar Personal");
				...
				comboDireccion.setBounds(702, 66, 494, 26);
				...
				btnBuscar.setBounds(1079, 143, 117, 29);
				...
				scrollPane.setBounds(18, 187, 1404, 388);
				add(scrollPane);
				table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF); 

				JButton btnTodo = new JButton("Mostrar todo");
				btnTodo.setBounds(1171, 586, 185, 51);
				...
				btnSalir.setBounds(18, 586, 85, 81);
				add(btnSalir);
