			...
			try {
				...
				btnRegistrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						if(salida.equals("Paciente registrado")&&salida2.equals("Paciente registrado")) {
							...
							JOptionPane.showMessageDialog(null, "Algo ha salio mal, revisa los datos ingresados");
						}
				...
				btnRegistrar.setBounds(1040, 609, 185, 71);
				add(btnRegistrar);
