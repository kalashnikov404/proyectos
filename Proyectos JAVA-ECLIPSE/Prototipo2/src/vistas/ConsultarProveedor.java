	...
	public ConsultarProveedor(String usuario) {
		...
		if(usuario.equals("dueño")) {
			...
			try {
				...
				btnNewButton.setBounds(1191, 153, 117, 29);
				add(btnNewButton);


				rdRazonSocial = new JRadioButton("N. Seguro Social");
				...
				scrollPane.setBounds(10, 187, 1346, 378);
				add(scrollPane);
				table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF); 
				...
				btnMostrarTodo.setBounds(1123, 596, 185, 71);
				add(btnMostrarTodo);
				...
				cbRazonSocial.setBounds(165, 73, 439, 29);
				add(cbRazonSocial);
				...
				cbNombre.setBounds(801, 74, 527, 26);
				add(cbNombre);
				...
				btnSalir.setBounds(6, 576, 85, 81);
				add(btnSalir);
