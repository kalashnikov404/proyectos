	...
	public ConsultarSocio(String usuario) {
		...
		if(usuario.equals("dueño") || usuario.equals("empleado")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Consultar Informes");
				...
				comboDireccion.setBounds(802, 68, 554, 26);
				...
				String nombreColunas[] = {"Nombre", "Fecha", "Tipo"};
				...
				JRadioButton rbDireccion = new JRadioButton("Fecha");
				rbDireccion.setBounds(673, 68, 117, 23);
				add(rbDireccion);



				JRadioButton rbTelefono = new JRadioButton("Tipo");
				...
				btnBuscar.setBounds(1239, 147, 117, 29);
				...
				scrollPane.setBounds(18, 187, 1404, 382);
				add(scrollPane);
				table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF); 

				JButton btnTodo = new JButton("Mostrar todo");
				btnTodo.setBounds(1141, 580, 185, 71);
				...
				btnSalir.setBounds(28, 580, 85, 81);
				add(btnSalir);
