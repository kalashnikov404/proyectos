	...
	public ModificarSocio(String usuario) {
		...
		if(usuario.equals("dueño")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Modificar Informe");
				...
				JLabel lblSocio = new JLabel("Informe:");
				...
				cbSocios.setBounds(75, 144, 782, 27);
				...
				JLabel lblDireccion = new JLabel("Fecha:");
				...
				JButton btnModificar = new JButton("Modificar informe");
				btnModificar.setBounds(1118, 551, 185, 71);
				...
				btnModificar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(salida.equals("Informe modificado")) {
				...
				btnSalir.setBounds(41, 551, 85, 81);
				...
				JButton btnBorrarSocio = new JButton("Borrar Informe");
				btnBorrarSocio.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(salida.equals("Informe borrado")) {
				...
				btnBorrarSocio.setBounds(884, 551, 185, 71);
				add(btnBorrarSocio);
