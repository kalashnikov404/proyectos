	...
	System.out.println(tokensSeparados.get(i).toString());
		...
		btnExportarArchivoTokens.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(!tokens.isEmpty()) {
					try {
						File fichero = new File("C:\\Users\\Grudges\\eclipse-workspace\\APP ANALIZADOR SEMANTICO\\src\\tokens.txt"); // RUTA  LAP 
...
//				tokensSeparados.add("tk_BEGIN");
				...
				for (int j = 0; j < pila.size(); j++) {
					...
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\Grudges\\eclipse-workspace\\APP ANALIZADOR SEMANTICO\\src\\nodosSintactico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(erroresSemanticos.isEmpty()) {
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\Grudges\\eclipse-workspace\\APP ANALIZADOR SEMANTICO\\src\\arbolSemantico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
...
// Agregar nodos del analisis semantico
	...
	// Padres y referencia a nodos del analisis sintactico
