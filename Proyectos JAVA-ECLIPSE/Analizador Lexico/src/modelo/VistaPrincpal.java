	...
	System.out.println(tokensSeparados.get(i).toString());
		...
		btnExportarArchivoTokens.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(!tokens.isEmpty()) {
					try {
						File fichero = new File("C:\\Users\\HP\\Desktop\\tokens.txt"); // RUTA  LAP 
...
//				tokensSeparados.add("tk_BEGIN");
				...
				for (int j = 0; j < pila.size(); j++) {
					...
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\HP\\Desktop\\nodosSintactico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(erroresSemanticos.isEmpty()) {
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\HP\\Desktop\\arbolSemantico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
