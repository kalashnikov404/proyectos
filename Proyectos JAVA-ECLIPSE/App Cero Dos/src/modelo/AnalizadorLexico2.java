...
public class AnalizadorLexico2 extends JFrame {
    ...
    private void crearArchivo4(String texto) {
        try {
            FileWriter escrito = new FileWriter("C:\\Users\\Grudges\\Desktop\\Automatas\\ListaDeTokens.txt");
	...
	public void escribeSinRepetidos() throws IOException {
		 String filePath = "C:\\Users\\Grudges\\Desktop\\Automatas\\Uno.txt";
	      String input = null;
	      //Instantiating the Scanner class
	      Scanner sc = new Scanner(new File(filePath));
	      //Instantiating the FileWriter class
	      FileWriter writer = new FileWriter("C:\\Users\\Grudges\\Desktop\\Automatas\\Dos.txt");
	...
	public void muestraSinRepetidos() {
		String codigo = new String(), path = "C:\\Users\\Grudges\\Desktop\\Automatas\\Dos.txt";
...
txp2.setText(codigo);
    ...
    private void crearArchivo2(String texto) {
        try {
            FileWriter escrito = new FileWriter("C:\\Users\\Grudges\\Desktop\\Automatas\\Uno.txt");
            PrintWriter imprime = new PrintWriter(escrito);
            imprime.print(texto);
            escrito.close();
        } catch (IOException e) {
