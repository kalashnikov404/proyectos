	...
	public ModificarCalentador(String usuario) {
		...
		if(usuario.equals("dueño")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Modificar Calentador");
				...
				JLabel lblNumCilindros = new JLabel("NÃºm. cilindros");
				...
				btnModificar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						if(salida.equals("Calentador modificado")) {
							tfTipo.setText(null);
							...
							JOptionPane.showMessageDialog(null, "Algo sa³ mal, revisa los datos ingresados");
						}
					}
				});
				...
				btnEliminar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(salida.equals("Calentador borrado")) {
							tfTipo.setText(null);
							tfNumCilindros.setText(null);
							tfDimensiones.setText(null);
							tfMarca.setText(null);
