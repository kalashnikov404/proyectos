...
public class Login extends JFrame {
	...
	public Login() {
		...
		try {
			...
			lblRes.setBounds(323, 249, 223, 47);
			...
			btnIniciar.setBounds(323, 267, 190, 29);
			contentPane.add(btnIniciar);
			
			JLabel lblNewLabel = new JLabel("");
			lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/ronop.png")));
			lblNewLabel.setBounds(0, 193, 277, 221);
