...
public class ConsultarTransporte extends JPanel {
	...
	public ConsultarTransporte(String usuario) {
		...
		try {
			...
			JLabel lblTitulo = new JLabel("Consultar Transporte");
			...
			String nombreColunas[] = {"Placas", "Tipo"};
			...
			JRadioButton rbPlacas = new JRadioButton("Placas");
			...
			cbPlacas.setBounds(96, 129, 156, 27);
			add(cbPlacas);
			...
			cbTipo.setBounds(418, 129, 156, 27);
			add(cbTipo);
