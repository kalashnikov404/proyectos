	...
	public ModificarTransporte(String usuario) {
		...
		if(usuario.equals("dueño")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Modificar Transporte");
				...
				JButton btnModificar = new JButton("Modificar transporte");
				btnModificar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(salida.equals("Transporte modificado")) {
				...
				JButton btnEliminar = new JButton("Eliminar transporte");
				btnEliminar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						String salida = serviceTransporte.eliminarTransporte(oldTransporte);
						if(salida.equals("Transporte eliminado")) {
							tfPlacas.setText(null);
							 tfTipo.setText(null);
							JOptionPane.showMessageDialog(null, salida);
						}else {
