	...
	public ConsultarCalentador(String usuario) {
		...
		if(usuario.equals("dueño") || usuario.equals("empleado")) {
			...
			try {
				...
				JLabel lblTitulo = new JLabel("Consultar Calentadores");
				...
				String nombreColunas[] = {"Tipo", "Numero Cilindros","Dimensiones","Marca", "Precio"};
				...
				JRadioButton rbNumeroCilindros = new JRadioButton("Numero Cilindros");
				rbNumeroCilindros.setBounds(23, 129, 143, 23);
				add(rbNumeroCilindros);

				JRadioButton rbDimensiones = new JRadioButton("Dimensiones");
				...
				cbDimensiones.setBounds(813, 130, 164, 24);
				add(cbDimensiones);
				...
				btnBuscar.setBounds(1306, 150, 105, 25);
				add(btnBuscar);
