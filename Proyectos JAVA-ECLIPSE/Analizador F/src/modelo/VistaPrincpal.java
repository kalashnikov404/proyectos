...
public class VistaPrincpal extends JFrame {
	...
	public VistaPrincpal() {
		...
		scrollText.setBorder(new LineBorder(new Color(30, 144, 255), 2, true));
		scrollText.setBounds(22, 29, 546, 448);
		...
		scrollErrores.setBorder(new LineBorder(new Color(0, 102, 255), 2, true));
		...
		scrollPane.setBorder(new LineBorder(new Color(0, 102, 255), 2, true));
		scrollPane.setBounds(635, 29, 347, 448);
...
for (int i = 0; i < tokensSeparados.size(); i++) {
	System.out.println(tokensSeparados.get(i).toString());
		...
		btnAnalizar.setBounds(63, 544, 125, 39);
		...
		btnExportarArchivoTokens.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(!tokens.isEmpty()) {
					try {
						File fichero = new File("C:\\Users\\Grudges\\Desktop\\tokens.txt"); // RUTA  LAP 
		...
		btnExportarArchivoTokens.setBounds(241, 544, 125, 39);
...
//				tokensSeparados.add("tk_BEGIN");
				...
				for (int j = 0; j < pila.size(); j++) {
					...
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\Grudges\\Desktop\\nodosSintactico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
		...
		btnSintactico.setBounds(401, 544, 183, 39);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(baderaErrorSemantico==false) {
					if(!nodos.isEmpty()) {
						try {
							File fichero = new File("C:\\Users\\Grudges\\Desktop\\arbolSemantico.txt"); // RUTA  LAP 
							FileOutputStream fos = new FileOutputStream(fichero);
		...
		btnNewButton.setBounds(614, 544, 188, 39);
	...
	public void analizar(String cod) {
		...
		String patron=("(BEGIN)|"//grupo 1
				+"(END)|"//grupo 2
				+ "(INTEGER|REAL)|" //grupo 3
				+"(ADD|SUB|MUL|DIV)|"// grupo 4
				+"(READ|WRITE)|"// grupo 5
				+ "([a-z][0-9]{1,3})|" //grupo 6
				+ "(\\.)|" //grupo 7
				+("(;)|")// grupo 8
...
//			}
	...
	public  void AnalisisSitactico(int i) {
		...
		if(tokensSeparados.get(i).equals("tk_BEGIN")) {
		...
		}else if(tokensSeparados.get(i).equals("tk_WRITE") || 
				tokensSeparados.get(i).equals("tk_READ")) {
			...
			if(tokensSeparados.get(i).equals("tk_(")) {
				...
				if(tokensSeparados.get(i).equals("tk_var") || 
						tokensSeparados.get(i).equals("tk_entero") ||
		...
		}else if(tokensSeparados.get(i).equals("tk_INTEGER") || 
				tokensSeparados.get(i).equals("tk_REAL")) {
		//	System.out.println("entro a integer");
		...
		}else if(tokensSeparados.get(i).equals("tk_ADD") || tokensSeparados.get(i).equals("tk_SUB") 
				|| tokensSeparados.get(i).equals("tk_MUL")
				|| tokensSeparados.get(i).equals("tk_DIV")) {
			...
			pila.add(new Token(token, lexema));
			i++;
			if(tokensSeparados.get(i).equals("tk_END")) {
				//pila.add(tokensSeparados.get(i));
				String token2 = tokensSeparados.get(i);
				String lexema2 = lexemas.get(i);
				pila.add(new Token(token2, lexema2));
			...
			if(tokensSeparados.get(i).equals("tk_=")) {
				...
				pila.add(new Token(token2, lexema2));
				i++;
				if(tokensSeparados.get(i).equals("tk_ADD") || tokensSeparados.get(i).equals("tk_SUB") 
						|| tokensSeparados.get(i).equals("tk_MUL")
						|| tokensSeparados.get(i).equals("tk_DIV")) {
					//pila.add(tokensSeparados.get(i));
					String token3 = tokensSeparados.get(i);
...
//				verificaReglasOperacion(cadena5);
	...
	public  void verificaReglasOperacion(String token) {
		if(token.equals("tk_ADD") || token.equals("tk_SUB") || token.equals("tk_MUL") || token.equals("tk_DIV")) {
			agregarNodo(pila.get(pila.size()-1).getLexema(),pila.get(pila.size()-1).getToken());
			pila.remove(pila.size()-1);
			//pila.add("R");
	...
	public  void obtenerTokensDeclaracion(ArrayList<Token> pila,int i) {
		if(tokensSeparados.get(i).equals("tk_;")) {
			...
			pila.add(new Token(token, lexema));
			i++;
			if(tokensSeparados.get(i).equals("tk_entero") || 
					tokensSeparados.get(i).equals("tk_decimal")) {
				//pila.add(tokensSeparados.get(i));
				String token2 = tokensSeparados.get(i);
				String lexema2 = lexemas.get(i);
	...
	public  void verificaRegla(String toknen,int i) {
		if(toknen.equals("tk_WRITE") || toknen.equals("tk_READ")) {
			agregarNodo(pila.get(pila.size()-1).getLexema(),pila.get(pila.size()-1).getToken());
			pila.remove(pila.size()-1);
...
//			pila.add("A");
	...
	public  void verificaReglasDeclaracion(String toknen) {
		if(toknen.equals("tk_INTEGER") || toknen.equals("tk_REAL")) {
			agregarNodo(pila.get(pila.size()-1).getLexema(),pila.get(pila.size()-1).getToken());
			pila.remove(pila.size()-1);
	...
	public  void agregarNodo(String lexema,String sacoPila) {
		...
		//}
			...
			while(econtrarHijoInte==false ) {
				//if(tamañoNodos>1) {
				if(nodos.get(posiAtras).getNombre().equals("tk_WRITE") && nodos.get(posiAtras).getPadre()==0 ||
						nodos.get(posiAtras).getNombre().equals("tk_READ") && nodos.get(posiAtras).getPadre()==0) {
			...
			while(econtrarHijoInte==false ) {
				//if(tamañoNodos>1) {
				if(nodos.get(posiAtras).getNombre().equals("tk_INTEGER") && nodos.get(posiAtras).getPadre()==0 ||
			...
			while(econtrarHijoInte==false ) {
				//if(tamañoNodos>1) {
				if(nodos.get(posiAtras).getNombre().equals("tk_ADD") && nodos.get(posiAtras).getPadre()==0 ||
						nodos.get(posiAtras).getNombre().equals("tk_SUB") && nodos.get(posiAtras).getPadre()==0 ||
			...
			while(econtrarHijoInte==false ) {
				...
				if(nodos.get(posiAtras).getNombre().equals("tk_}") && nodos.get(posiAtras).getPadre()==0) {
					...
					posiAtras--;
					tamañoNodos--;
					if(nodos.get(posiAtras).getNombre().equals("tk_END") && nodos.get(posiAtras).getPadre()==0) {
						econtrarHijoInte=true;
						nodos.get(respaldo).setPadre(nodos.get(nodos.size()-1).getNumero());
						nodos.get(posiAtras).setPadre(nodos.get(nodos.size()-1).getNumero());
					}
			...
			while(econtrarHijoInte==false ) {
				//if(tamañoNodos>1) {
				if(nodos.get(posiAtras).getNombre().equals("tk_BEGIN") && nodos.get(posiAtras).getPadre()==0) {
					econtrarHijoInte=true;
					nodos.get(posiAtras).setPadre(nodos.get(nodos.size()-1).getNumero());
	...
	public void verificaErrores(int j) {
		...
		if(j< tokensSeparados.size()) {
			if(tokensSeparados.get(j).equals("tk_BEGIN")) {
				j++;
				verificaErroresInicio(j);
			}else if(tokensSeparados.get(j).equals("tk_WRITE") || tokensSeparados.get(j).equals("tk_READ")) {
				lineas++;
				j++;
				verificaErroresWriteRead(j);
			}else if(tokensSeparados.get(j).equals("tk_INTEGER") || tokensSeparados.get(j).equals("tk_REAL")) {
				lineas++;
				j++;
				System.out.println("entro a integer");
			...
			}else if(tokensSeparados.get(j).equals("tk_ADD") || tokensSeparados.get(j).equals("tk_SUB") ||
	...
	public void verificaErroresInicio(int j) {
		if(tokensSeparados.get(j).equals("tk_{")) {
			j++;
			if(tokensSeparados.get(j).equals("tk_WRITE") || tokensSeparados.get(j).equals("tk_READ") ||
					tokensSeparados.get(j).equals("tk_INTEGER") || tokensSeparados.get(j).equals("tk_REAL") ||
					tokensSeparados.get(j).equals("tk_ADD") || tokensSeparados.get(j).equals("tk_SUB") ||
					tokensSeparados.get(j).equals("tk_MUL") || tokensSeparados.get(j).equals("tk_DIV") ||
	...
	public void verificaErroresFin(int j) {
		if(tokensSeparados.get(j).equals("tk_END")) {
			j++;
			if(j<tokensSeparados.size()) {
			if(tokensSeparados.get(j).equals("tk_WRITE") || tokensSeparados.get(j).equals("tk_READ") ||
					tokensSeparados.get(j).equals("tk_INTEGER") || tokensSeparados.get(j).equals("tk_REAL") ||
	...
	public void analisisSemantico(int i,ArrayList<Nodo> nodos) {
		if(i<nodos.size()) {
		if(nodos.get(i).getNombre().equals("tk_INTEGER") || nodos.get(i).getNombre().equals("tk_REAL")) {
			int posicion = i;
		...
		}else if(nodos.get(i).getNombre().equals("tk_ADD") || 
		...
		}else if(nodos.get(i).getNombre().equals("tk_WRITE") || nodos.get(i).getNombre().equals("tk_READ")) {
			i++;
			...
			if(nodos.get(i).getNombre().equals("tk_=")) {
				...
				if(nodos.get(i).getNombre().equals("tk_var")) {
					...
					if(nodos.get(posicionCodigo).getTipo().equals(nodos.get(i).getTipo())) {
						...
						System.out.println("No esta correctamente asignada la operacion a la variable: "+nodos.get(i).getLexema());
						textPaneErrores.setText("No esta correctamente asignada la operacion a la variable: "+nodos.get(i).getLexema());
						baderaErrorSemantico = true;
					}
					}else {
