...
public class Simple {
    ...
    public static void main(String[] args) {
        String jdbcURL = "jdbc:mysql://localhost:3306/contenedorcsv";
        ...
        try {
          ...
          // "INSERT INTO review (course_name, student_name, timestamp, rating, comment) VALUES (?, ?, ?, ?, ?)";
           ...
           String sql =" INSERT INTO datos(cve_ent ,poblacion, nombre, f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
