...
public class Cine extends JFrame {
	...
	public Cine() {
		...
		menuSucursal.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 20));
		...
		menuEmpleados.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 20));
		...
		menuPeliculas.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
...
//			
		...
		menuCartelera.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
		...
		menuBoletos.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
...
//				
		...
		menuProveedores.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
		...
		menuResurtidos.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
		...
		menuVentas.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 22));
		menuBar.add(menuVentas);
		
		lbReloj = new JLabel("New label");
		lbReloj.setForeground(new Color(204, 51, 0));
		lbReloj.setFont(new Font("Segoe UI Black", Font.PLAIN, 12));
		menuBar.add(lbReloj);
