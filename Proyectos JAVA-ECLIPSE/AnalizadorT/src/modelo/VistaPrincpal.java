...
for (int i = 0; i < tokensSeparados.size(); i++) {
	System.out.println(tokensSeparados.get(i).toString());
		...
		btnAnalizar.setBounds(303, 32, 125, 39);
		...
		btnExportarArchivoTokens.setBounds(455, 32, 125, 39);
...
//				tokensSeparados.add("tk_BEGIN");
		...
		btnSintactico.setBounds(590, 32, 183, 39);
		...
		btnNewButton.setBounds(794, 32, 188, 39);
		...
		btnAbrir.setBounds(22, 32, 125, 39);
		...
		btnLimpiar.setBounds(157, 32, 125, 39);
