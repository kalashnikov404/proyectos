...
public class PanelBoletosRegistrar extends JPanel {
	...
	private static JComboBox comboSala;
	private static JComboBox comboCantidad;
	private static JComboBox comboEmpleado;
	private static JComboBox comboPrecio;
	...
	int perro;
	 String pps2;
		...
		private static JComboBox comboDuracion;
	...
	public PanelBoletosRegistrar() {
	 ...
	 comboPrecio = new JComboBox();
        ...
        cajaPrecio.setBounds(574, 0, 219, 75);
		...
		add(cajaPrecio);
			...
			/*    LIMIT INPUT OF TEXT FIELD TO NUMBERS ONLY   */
			        /*        SOURCE: FROM SUN JAVA'S TUTORIALS        */
...
//		
        ...
        cajaTipo.setBounds(574, 75, 219, 75);
...
//		add(comboPelicula);
		...
		cajaPelicula.setBounds(574, 150, 219, 75);
		cajaPelicula.setColumns(10);
		cajaPelicula.setFont(new Font("Impact", Font.PLAIN, 25));
		add(cajaPelicula);
		
		
		cajaPelicula.addKeyListener(new KeyAdapter() {
	         public void keyTyped(KeyEvent e) {
	           char c = e.getKeyChar();
	           if (!(Character.isDigit(c) ||
	              (c == KeyEvent.VK_BACK_SPACE) ||
...
//		
    	...
    	comboSala.addItem("Seleccione una opcion");
	        ...
	        cajaSala.setBounds(574, 225, 219, 75);
	        cajaSala.setFont(new Font("Impact", Font.PLAIN, 25));

			add(cajaSala);
	        cajaSala.setColumns(10);
			
	        cajaSala.addKeyListener(new KeyAdapter() {
		         public void keyTyped(KeyEvent e) {
		           char c = e.getKeyChar();
		           if (!(Character.isDigit(c) ||
		              (c == KeyEvent.VK_BACK_SPACE) ||
		...
		cajaCantidad.setBounds(225, 300, 568, 75);
		cajaCantidad.setFont(new Font("Impact", Font.PLAIN, 25));
		add(cajaCantidad);
		cajaCantidad.setColumns(10);
		
		cajaCantidad.addKeyListener(new KeyAdapter() {
		         public void keyTyped(KeyEvent e) {
		           char c = e.getKeyChar();
		           if (!(Character.isDigit(c) ||
		              (c == KeyEvent.VK_BACK_SPACE) ||
...
comboEmpleado.setFont(new Font("Impact", Font.PLAIN, 25));
		...
		cajaEmpleado.setBounds(574, 375, 219, 75);
		...
		cajaEmpleado.addKeyListener(new KeyAdapter() {
	         public void keyTyped(KeyEvent e) {
	           char c = e.getKeyChar();
	           if (!(Character.isDigit(c) ||
	              (c == KeyEvent.VK_BACK_SPACE) ||
...
//		
	...
	public boolean estanVaciosBoletos() {
		...
		return
		comboPrecio.getSelectedItem().equals("Seleccione una opcion")	||
		comboTipo.getSelectedItem().equals("Seleccione una opcion")	||
		comboDuracion.getSelectedItem().equals("Seleccione una opcion")	||
		comboSala.getSelectedItem().equals("Seleccione una opcion")	||
		comboEmpleado.getSelectedItem().equals("Seleccione una opcion")	||
		
		
		cajaPrecio.getText().isEmpty()||
		cajaTipo.getText().isEmpty()||
		cajaPelicula.getText().isEmpty()||
		
		cajaSala.getText().isEmpty()||
		cajaCantidad.getText().isEmpty()||
		cajaEmpleado.getText().isEmpty();
...
//			||cajaSala.getText().isEmpty()||cajaCantidad.getText().isEmpty()||cajaEmpleado.getText().isEmpty();
	...
	public void vaciarCajasBoletos() {
		comboPrecio.setSelectedItem("Seleccione una opcion");
		comboTipo.setSelectedItem("Seleccione una opcion");
		comboDuracion.setSelectedItem("Seleccione una opcion");
		comboSala.setSelectedItem("Seleccione una opcion");
		comboEmpleado.setSelectedItem("Seleccione una opcion");
