...
//
	...
	private static JComboBox comboProveedor;
	private static JComboBox comboSucursal;
	private static JComboBox comboBotana;
	private static JComboBox comboResurtido;
...
//		
			...
			cajaProveedor.addKeyListener(new KeyAdapter() {
...
//		
		...
		cajaSucursal.addKeyListener(new KeyAdapter() {
	         public void keyTyped(KeyEvent e) {
	           char c = e.getKeyChar();
	           if (!(Character.isDigit(c) ||
	              (c == KeyEvent.VK_BACK_SPACE) ||
		...
		cajaC.addKeyListener(new KeyAdapter() {
	         public void keyTyped(KeyEvent e) {
	           char c = e.getKeyChar();
	           if (!(Character.isDigit(c) ||
	              (c == KeyEvent.VK_BACK_SPACE) ||
...
//		  final JComboBox optionsCombo = new JComboBox(options);
		...
		cajaBotana.addKeyListener(new KeyAdapter() {
	         public void keyTyped(KeyEvent e) {
	           char c = e.getKeyChar();
	           if (!(Character.isDigit(c) ||
	              (c == KeyEvent.VK_BACK_SPACE) ||
...
//		
	...
	public boolean estanVaciosResurtidos() {
//
...
comboProveedor.getSelectedItem().equals("Seleccione una opcion")||comboEmpleado.getSelectedItem().equals("Seleccione una opcion")||
		comboSucursal.getSelectedItem().equals("Seleccione una opcion")||
		comboBotana.getSelectedItem().equals("Seleccione una opcion")||

		
//		
		cajaProveedor.getText().isEmpty()||
		cajaC.getText().isEmpty()||
		cajaCantidad.getText().isEmpty()||
		cajaC.getText().isEmpty()||
		cajaBotana.getText().isEmpty()||
		cajaEmpleado.getText().isEmpty();

				
				
				
//				cajaNombre.getText().isEmpty()||cajaDuracion.getText().isEmpty()||cajaClasificacion.getText().isEmpty()||comboGenero.getSelectedItem().equals("Seleccione una opción")
//			||cajaSala.getText().isEmpty()||cajaCantidad.getText().isEmpty()||cajaEmpleado.getText().isEmpty();
	}
	public void vaciarCajasResurtidos() {
//		cajaDuracion.setText("");
		comboProveedor.setSelectedItem("Seleccione una opcion");
		comboEmpleado.setSelectedItem("Seleccione una opcion");
		comboSucursal.setSelectedItem("Seleccione una opcion");
		comboBotana.setSelectedItem("Seleccione una opcion");

		
//		
		cajaProveedor.setText("");
		cajaSucursal.setText("");
