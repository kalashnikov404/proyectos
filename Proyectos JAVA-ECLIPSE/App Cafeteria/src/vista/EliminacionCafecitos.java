...
public class EliminacionCafecitos extends JPanel {
	private JTextField tfId;

	private int modificacion;
	private Cafecito cafecitoPrub;
	
	public EliminacionCafecitos() {
		setLayout(null);

		
		JLabel lblInstrucciones = new JLabel("Ingresa la clave del cafecito a eliminar");
