...
//		cajaDuracion.setColumns(10);
		...
		JLabel lblNewLabel5 = new JLabel("Baja");
...
//		
		...
		cajaPrecio.setBounds(225, 225, 489, 75);
...
//		add(comboEmpleado);
		...
		comboEmpleado.setBounds(225, 450, 350, 75);
...
comboEmpleado.setFont(new Font("Impact", Font.PLAIN, 25));
		...
		cajaEmpleado.setBounds(574, 450, 140, 75);
		...
		lblNewLabel8.setBounds(0, 450, 225, 75);
		...
		comboBotana.setBounds(225, 375, 350, 75);
...
//		  final JComboBox optionsCombo = new JComboBox(options);
		...
		cajaBotana.setBounds(574, 375, 140, 75);
